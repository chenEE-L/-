...
//	portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
	...
	g_mods_timeout = 0;
	timeout = 35000000 / UART2_BAUD;			/* 计算超时时间，单位us 35000000,使用串口2*/
...
static void MODS_SendWithCRC(uint8_t *_pBuf, uint8_t _ucLen)
{
	...
	comSendBuf(COM2,buf,_ucLen);//设定参数
