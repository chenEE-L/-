...
#define SD_PWR_ON()         GPIO_ResetBits(GPIOC,GPIO_Pin_4)  //SD卡上电
#define SD_PWR_OFF()        GPIO_SetBits(GPIOC,GPIO_Pin_4)   //SD卡断电
#define SD_DET()           !GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5) //检测有卡
                                                                    //1-有 0-无

/* Private function prototypes -----------------------------------------------*/
void SPI_Configuration(void);
void SD_IO_Configuration(void);
