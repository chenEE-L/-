...
void SPI_Configuration(void)
{
	...
	SPI_Cmd(SPI1, DISABLE);              //必须先禁能,才能改变
...
/*******************************************************************************
* Function Name  : SD_IO_Configuration
* Description    : 初始化SD卡IO
* Input          : None
* Output         : None
* Return         : None 
*******************************************************************************/
